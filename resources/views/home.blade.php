...
@section('content')
  ...
  <section class="relative overflow-hidden bg-gradient-to-br from-indigo-600 via-indigo-700 to-purple-800">
    ...
    <div class="relative mx-auto max-w-7xl px-4 py-24 sm:px-6 sm:py-32 lg:px-8">
      <div class="text-center">
        <span
          class="inline-flex items-center gap-2 rounded-full bg-white/10 px-4 py-1.5 text-sm font-medium text-indigo-100 backdrop-blur-sm">
        ...
        <p class="mx-auto mt-6 max-w-2xl text-lg text-indigo-100/80">
          Explore our curated collection of high-quality products. From electronics to lifestyle essentials, find
          everything you need in one place.
        </p>
        <div class="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
          <a href="{{ route('shop.index') }}"
            class="group inline-flex items-center gap-2 rounded-2xl bg-white px-8 py-4 text-sm font-bold text-indigo-700 shadow-xl transition-all hover:shadow-2xl hover:-translate-y-0.5">
            Shop Now
          ...
          <a href="{{ route('shop.index') }}"
            class="inline-flex items-center gap-2 rounded-2xl border-2 border-white/20 px-8 py-4 text-sm font-bold text-white transition-all hover:bg-white/10">
            Browse Categories
          </a>
        </div>
      </div>
  ...
  <section class="mx-auto max-w-7xl px-4 pb-20 sm:px-6 lg:px-8">
    <div class="flex items-center justify-between">
      ...
      <a href="{{ route('shop.index') }}"
        class="hidden sm:inline-flex items-center gap-1 text-sm font-semibold text-indigo-600 hover:text-indigo-700 transition-colors">
        View All
        ...
        <div class="text-center">
          <div class="mx-auto flex h-12 w-12 items-center justify-center rounded-2xl bg-purple-50">
            <svg class="h-6 w-6 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                d="M8 7h12m0 0L16 3m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4" />
            </svg>
          </div>
