...
@section('content')
    ...
    <div class="mt-8 mx-auto max-w-2xl">
        <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm sm:p-8">
            @csrf
            <div class="space-y-5">
                <x-form-input name="name" label="Product Name" placeholder="e.g. Wireless Headphones" required />

                <x-form-input name="description" type="textarea" label="Description" placeholder="Describe your product..." required />

                <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                    <x-form-input name="price" type="number" label="Price ($)" placeholder="0.00" required step="0.01" min="0" />
                ...
                <div>
                    ...
                    <input type="text" name="category" id="category" value="{{ old('category') }}" list="categories" required placeholder="Select or type category"
